...
def main():
    ...
    bot.hex.move_in_place(z=0.15)			#from 0.1
    bot.hex.modify_stance(-0.02)
    bot.hex.move_in_world(x_stride=0.15, num_cycles=2, gait_type="tripod")
    bot.hex.move_in_world(y_stride=0.15, num_cycles=2, gait_type="ripple")
    bot.hex.move_in_world(x_stride=-0.15, num_cycles=2, gait_type="wave")
    bot.hex.move_in_world(y_stride=-0.15, num_cycles=2, gait_type="wave")
